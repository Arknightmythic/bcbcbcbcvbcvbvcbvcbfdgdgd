...
const CollapsedTabButton = ({
  ...
  <Tooltip text={`${tooltipText} (${count})`}>
    <div className="relative flex items-center justify-center w-8 h-10 bg-gray-100 rounded-lg text-gray-600 hover:bg-bOss-red-50 hover:text-bOss-red transition-colors">
