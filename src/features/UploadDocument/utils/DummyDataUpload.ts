...
export const DUMMY_UPLOADED_DOCS: UploadedDocument[] = [
    ...
    { id: 2, upload_date: '2025-10-26', document_name: 'Uraian Jabatan Marketing.pdf', document_type: 'PDF', staff: 'Beni Saputra', team: 'Marketing', status: 'completed', file_path: '/path/to/doc2.pdf', category: 'uraian', version:1},
    ...
    { id: 5, upload_date: '2025-10-23', document_name: 'Materi Training Sales.pdf', document_type: 'PDF', staff: 'Beni Saputra', team: 'Marketing', status: 'failed', file_path: '/path/to/doc5.pdf', category: 'panduan', version:1 },
    ...
    { id: 8, upload_date: '2025-10-20', document_name: 'Jadwal Piket Keamanan.pdf', document_type: 'PDF', staff: 'Fajar Nugraha', team: 'Security', status: 'pending', file_path: '/path/to/doc8.pdf', category: 'uraian', version:1 },
    ...
    { id: 10, upload_date: '2025-10-18', document_name: 'Template Presentasi Perusahaan.pdf', document_type: 'PDF', staff: 'Beni Saputra', team: 'Marketing', status: 'completed', file_path: '/path/to/doc10.pdf', category: 'panduan', version:1 },
...
export const DUMMY_VERSIONS: { [key: number]: DocumentVersion[] } = {
  ...
  2: [
    { version: 1, document_name: 'Uraian Jabatan Marketing.pdf', upload_date: '2025-10-26', staff: 'Beni Saputra', file_path: '/path/to/doc2.pdf' },
  ]
};