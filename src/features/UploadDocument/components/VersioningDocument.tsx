        ...
        {isPending ? (
          ...
          <>
            ...
            {hasPending && pendingDocument && (
              <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute bottom-full mb-2 w-64 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 -translate-x-1/2 left-1/2">
                      The previous version must be approved or rejected before
                ...
                <div className="mt-2 text-sm text-gray-700">
                  <p>
                    <strong>File Name:</strong> {pendingDocument.document_name}
                  </p>

                  <p className="flex items-center gap-2">
                    <strong>Status:</strong>{" "}
                    {getStatusComponent(pendingDocument.status ?? undefined)}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="flex justify-end gap-3 mt-6 border-t pt-4">
              ...
              <button
                onClick={handleConfirmVersioning}
                disabled={!file || isReplacing || hasPending}
