// src/features/TeamManagements/components/TeamTableRow.tsx

import React from 'react';
import { Edit, Trash2 } from 'lucide-react'; // Hapus 'Users'
import type { ActionType, Team } from '../utils/types';
import AccessRights from './AccessRights';

interface TeamTableRowProps {
  team: Team; // Tipe sudah diperbarui
